...
function OrderContent() {
  ...
  const isOnlinePayment = order?.payment === 'razorpay';
      ...
      <div className="container" style={{ maxWidth: 560, margin: '0 auto' }}>
        ...
        {order && (
          <>
            <div style={{ background: '#f9f6ef', borderRadius: 12, padding: 24, marginBottom: 24 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, fontSize: 14, color: 'rgba(58,36,26,0.6)' }}>
                ...
                {isOnlinePayment && (
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span>Shipping</span>
                    <span style={{ color: '#2e7d32', fontWeight: 600 }}>Free (Online Payment)</span>
                  </div>
                )}
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span>Delivery Estimate</span>
                  <span style={{ color: '#3A241A', fontWeight: 500 }}>{isOnlinePayment ? '2-3 business days (Priority)' : '3-5 business days'}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span>Phone</span>
            ...
            {isOnlinePayment ? (
              <div style={{
                background: '#f0faf0', border: '1px solid #c8e6c9', borderRadius: 16,
                padding: 24, marginBottom: 20, textAlign: 'center',
              }}>
                <div style={{ fontSize: 32, marginBottom: 12 }}>✅</div>
                <p style={{ fontSize: 15, color: '#2e7d32', fontWeight: 700, marginBottom: 8 }}>
                  Payment Confirmed &amp; Order Placed!
                </p>
                <p style={{ fontSize: 13, color: 'rgba(58,36,26,0.5)', lineHeight: 1.6 }}>
                  Your payment has been verified. Your order will be dispatched within 24 hours with <strong style={{ color: '#2e7d32' }}>priority processing</strong> and <strong style={{ color: '#2e7d32' }}>free shipping</strong>. You&rsquo;ll receive a tracking ID via WhatsApp once shipped.
                </p>
              </div>
            ) : (
              <div style={{
                ...
                <p style={{ fontSize: 13, color: '#1a7a3a', fontWeight: 600, marginBottom: 16, textAlign: 'center' }}>
                  ⚠️ Please send your order details to confirm
                </p>
                ...
                {!whatsappSent ? (
                  ...
                  >
                    I&rsquo;ve sent the message — Continue
                  </button>
                ) : (
                  <div style={{ textAlign: 'center', fontSize: 13, color: '#1a7a3a', fontWeight: 500 }}>
                    ✅ WhatsApp confirmation sent — you can now proceed
                  </div>
                )}
              </div>
            )}
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          {order && (whatsappSent || isOnlinePayment) && (
